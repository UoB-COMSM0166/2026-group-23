...
//  Level end panel (victory / defeat)
//  Migrated from sketch.js (was drawEndPanel / handleEndPanelClick)
//  Global dependencies: endPanelAnim, _endPanelWon, currentLevel, unlockedLevel,
...
function drawEndPanel() {
  ...
  // Animation interpolation factor; renamed to avoid shadowing i18n's t()
  ...
  // -- Button row 2: NEXT LEVEL (on victory and if there is a next level) --
