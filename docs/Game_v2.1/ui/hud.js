...
function drawHUD() {
  ...
  fill(0, 160, 255); textSize(13); text(t('hud.credits'), 12, 15);
  fill(255, 210, 40); textSize(18); text(_hudStr.credits, 12, 34);

  fill(0, 160, 255); textSize(13); text(t('hud.baseHp'), 145, 15);
  fill(_hudHpFill);
  textSize(18); text(_hudStr.hp, 145, 34);

  fill(0, 160, 255); textSize(13); text(t('hud.wave'), 285, 15);
  fill(waveState === 'complete' ? color(0, 255, 120) : color(140, 80, 255));
  textSize(18); text(_hudStr.wave, 285, 34);

  fill(0, 160, 255); textSize(13); text(t('hud.hostiles'), 395, 15);
